...
const Content = () => {
  return (
    ...
    <div className="container">
            <div className="row ">
                <div className="col-xs-12 col-md-12 col-lg-6"><Link to="/content"><img src={hero} alt=""/></Link></div>
                <div className="col-xs-12 col-md-12 col-lg-6">
                  <div className="box">
                    <div className="welcome">
                      ...
                      <Link to="/signup" > <button className="btn d-grid col-sm-12 col-lg-6" value=""><h5>Join the Data hub</h5></button></Link>  
                      </div>
                    </div>
                  </div>
                </div>
